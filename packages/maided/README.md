...
This is fork published to NPM as `maided`, because dependencies were not updated for a long time of the original repo - [https://github.com/egoist/maid](https://github.com/egoist/maid) and this seemed as the easiest solution.
