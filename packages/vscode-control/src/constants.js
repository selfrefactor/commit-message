...
export const JSX_SNIPPETS = `${HOME}/.config/Code/User/snippets/javascriptreact.json`
export const TS_SNIPPETS = `${HOME}/.config/Code/User/snippets/typescript.json`
export const TSX_SNIPPETS = `${HOME}/.config/Code/User/snippets/typescriptreact.json`