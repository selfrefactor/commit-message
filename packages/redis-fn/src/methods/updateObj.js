...
const updateObj = ({ redisClient, key, value, expiryFlag, expiryValue, defaultExpiryFlag, defaultExpiryValue }) => new Promise((resolve, reject) => {
  redisClient.get(key, (err, result) => {
    ...
    if (expiryFlag === true || defaultExpiryFlag === true) {
      ...
      redisClient.set(key, JSON.stringify(objToSet), 'EX', expiryPeriod)
    } else {
