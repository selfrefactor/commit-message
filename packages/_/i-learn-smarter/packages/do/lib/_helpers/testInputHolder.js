...
// tslint:disable
function getTestableModuleInput() {
    return {
        fileName: 'foo',
        folderPath: '',
        inputArguments: 'a,b',
...
exports.getTestableModuleInput = getTestableModuleInput;
function getEpicInput() {
    return {
        folder: 'FOO',
...
exports.getEpicInput = getEpicInput;
function getEpicInputWhenOuter() {
    return {
        folder: 'FOO',
        starterAction: 'see.then',
        name: 'bar.more',
...
exports.getEpicInputWhenOuter = getEpicInputWhenOuter;
...
// tslint:enable
//# sourceMappingURL=testInputHolder.js.map