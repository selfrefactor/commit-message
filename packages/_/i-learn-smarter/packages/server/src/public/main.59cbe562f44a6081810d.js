...
/*!******************************************!*\
  ...
  \******************************************/
/*! no static exports found */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const r=n(/*! ../../constants */"he5r"),o=n(/*! client-helpers */"RQK/"),i=n(/*! rambdax */"Ex95"),s=n(/*! rxjs/Observable */"4c1C"),a=n(/*! string-fn */"DOxJ"),c=n(/*! ../../_helpers/getNextIndex */"noCf"),l=n(/*! ../../bees/sharedNextReady */"LHni"),u=n(/*! ../../root/actions */"X9xb"),d=n(/*! ../actions */"o/T1"),p=n(/*! ../../_helpers/selectors */"NDrd"),E=n(/*! ../../bees/setConvertedImage */"0CO9"),f=n(/*! ../../bees/getConvertedImage */"ekhr");t.nextEpic=((e,t)=>e.ofType(r.WRITE_SENTENCE_NEXT).concatMap(()=>new s.Observable(e=>{const{currentIndex:n,db:s,ready:h}=t.getState().writeSentenceStore,{easier:g,easiest:_,easy:m,random:S,visible:v}=o.getterAnt(r.urlInputsDefault),{textToSpeechFlag:C}=p.getCommons(t),T=c.getNextIndex({index:n,length:s.length}),O=s[T];l.sharedNextReadyBee(O),E.setConvertedImageBee(O);const N=a.maskSentence({sentence:O.fromPart,easyMode:m,easierMode:g,randomMode:S,charLimit:_?1:4}),A=N.visible.map((e,t)=>({hidden:N.hidden[t],visible:v?N.hidden[t]:e})),I=Array(A.length).fill(null),x={currentIndex:T,currentInstance:O,okCorrect:I,question:A};e.next(d.setNext(x));const b=h?r.NEXT_TICK:r.SHORT_DELAY;Promise.all([f.getConvertedImageBee(O),i.delay(b)]).then(([t])=>{const n={currentIndex:T,currentInstance:O,okCorrect:I,question:A,convertedImage:t};e.next(d.setNext(n)),e.next({type:r.WRITE_SENTENCE_READY}),C&&e.next(u.sharedSpeakTo),e.complete()})})))},ZPtv:
/*!******************************!*\
...
/*!***************************************!*\
  ...
  \***************************************/
/*! no static exports found */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const r=n(/*! create-action */"Hxzp"),o=n(/*! ../constants */"he5r");t.mic=r.createAction(o.WRITE_SENTENCE_MIC),t.micReady=r.createAction(o.WRITE_SENTENCE_MIC_READY),t.check=r.createAction(o.WRITE_SENTENCE_CHECK),t.init=r.createAction(o.WRITE_SENTENCE_INIT),t.initReady=r.createAction(o.WRITE_SENTENCE_INIT_READY),t.listen=r.createAction(o.WRITE_SENTENCE_LISTEN),t.next=r.createAction(o.WRITE_SENTENCE_NEXT),t.setIndex=r.createAction(o.WRITE_SENTENCE_SET_INDEX),t.setNext=r.createAction(o.WRITE_SENTENCE_SET_NEXT),t.setOkCorrect=r.createAction(o.WRITE_SENTENCE_SET_OK_CORRECT),t.setInput=r.createAction(o.WRITE_SENTENCE_SET_INPUT),t.step=r.createAction(o.WRITE_SENTENCE_STEP),t.stop=r.createAction(o.WRITE_SENTENCE_STOP),t.notify=function(e){return{payload:{message:e,ms:4e3},type:"notify@INFO"}},t.notifyAnswer=function(e){return{payload:{message:e,ms:2500},type:"notify@INFO"}}},o2aO:
/*!*******************************************!*\
