...
`,t.QuestionBase=`\n  color: ${r.dark2};\n  letter-spacing: 0.1em;   \n\n  span:not(:first-child) {\n    margin-left: 6px;\n  }\n`,t.Question=o.default(a.getText(.5))`${t.QuestionBase}`,t.QuestionSmall=o.default(a.getText(.3))`${t.QuestionBase}`,t.QuestionMobile=o.default(a.getText(.25))`${t.QuestionBase}`,t.QuestionActive=o.default.span`
  margin: 7px;
  box-shadow: 
...
/*!*************************************!*\
  ...
  \*************************************/
/*! no static exports found */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const r=n(/*! redux */"fvjX");t.getComposeAnt=function(){return r.compose}},XjRs:
/*!***************************************!*\
  !*** ./src/ants/css_in_js/opacity.ts ***!
  \***************************************/
/*! no static exports found */
...
`;t.opacityAnt=((e=.3)=>r.css`animation: ${o} ${e}s ease-in;`)},Xnku:
/*!**********************************!*\
...
/*!**********************************************!*\
  ...
  \**********************************************/
/*! no static exports found */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const r=n(/*! colors */"dBCm"),o=n(/*! styled-components */"vOnD"),i=n(/*! ../../ants/css_in_js/opacity */"XjRs"),a=n(/*! ../../_styled/grid */"ZPtv"),s=n(/*! ./grid */"oOQG"),c=`color: ${r.darkblue};`,l=`color: ${r.darkblue6};`,u=`border-top: solid 1px ${r.green4};`,d=`border-top: solid 1px ${r.red3};`;t.AnswerContainer=o.default(a.CenteredWithId("ws_answer"))`
  width: 100%;
  grid-area: ws_answer;
...
/*!****************************************!*\
  ...
  \****************************************/
/*! no static exports found */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const r=n(/*! styled-components */"vOnD"),o=n(/*! ../styled/answer */"bjKX"),i=n(/*! ../styled/question */"MLjJ"),a=n(/*! ../styled/grid */"oOQG"),s=n(/*! colors */"dBCm"),c=4,l=102,u=1700;function d(e,t){return Number(Number.parseFloat(`${e/t}`).toFixed(2))}function p(e){const t=d(window.visualViewport.width,u),n=d(e,l);return console.log({windowRate:t,lengthRate:n}),d(function(e,t){return Number(Number.parseFloat(`${e/t}`).toFixed(2))}(t,n),c)}t.getBee=function(e){const t=p(e.fromPart.length);return console.log({rate:t}),{Question:r.default(a.getText(t))`${i.QuestionBase}`,Answer:r.default(a.getText(t))`${o.AnswerBase}`,Translation:r.default(a.getText(p(e.toPart.length)*1.2))`color: ${s.darkblue5};`}}},f6FE:
/*!*******************************!*\
