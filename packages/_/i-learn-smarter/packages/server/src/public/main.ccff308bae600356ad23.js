...
/*!******************************************!*\
  ...
  \******************************************/
/*! no static exports found */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const r=n(/*! ../../constants */"he5r"),o=n(/*! ../actions */"a44Q"),i=n(/*! ../bees/questionList */"ymlt"),s=n(/*! rambdax */"Ex95");const a=e=>{const{currentStep:t}=e.getState().lessonStore,n=t.example.includes("["),r=s.allTrue(n,function(e){return s.match(/\[([A-Za-z\.\]\[])*/g,e).filter(e=>e.includes(".")).length>0}(t.example)),a=t.example.split(" ").map(e=>s.test(/\[.*\]/,e)?i.questionListBee(e,r):e);return o.questionReady(a)};t.initQuestionEpic=((e,t)=>e.ofType(r.LESSON_NEXT).filter(()=>(e=>e.getState().lessonStore.currentStep.example)(t)).map(()=>a(t)))},"6QbG":
/*!***********************************!*\
