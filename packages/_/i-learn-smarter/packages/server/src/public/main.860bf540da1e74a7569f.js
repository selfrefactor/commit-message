...
/*!*************************************!*\
  ...
  \*************************************/
/*! no static exports found */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.isNextBee=function(e){return["next","nächste","следващ"].includes(e)}},"/I9d":
/*!******************************************!*\
...
/*!************************************************!*\
  ...
  \************************************************/
/*! no static exports found */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const r=n(/*! client-helpers */"RQK/"),o=n(/*! rambdax */"Ex95"),i=n(/*! ../../_helpers/bees/click */"A+jW"),s=n(/*! ../../_helpers/bees/isNext */"/4J7"),a=n(/*! ../../_helpers/mini/normalizeLanguage */"mVbh"),c=500;async function l(e){const t=e.results[0][0].transcript;if(console.log({spoken:t}),s.isNextBee(t))return i.clickBee("next");document.getElementsByTagName("input")[0].value=`${t}\n`,await o.delay(c),i.clickBee("submit")}t.acceptSpeechAnt=function(){const e=r.getter("fromLanguage"),t=new webkitSpeechRecognition,n=()=>{t.stop(),o.delay(c).then(()=>t.start())};t.lang=a.normalizeLanguage(e),t.interimResults=!1,t.continious=!0,t.maxAlternatives=1,t.onerror=n,t.onresult=l,t.onspeechend=n,t.start()}},JTIw:
/*!******************************!*\
