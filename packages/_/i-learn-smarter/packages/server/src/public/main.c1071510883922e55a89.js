...
/*!*****************************************!*\
  ...
  \*****************************************/
/*! no static exports found */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const r=n(/*! ../../constants */"he5r"),o=n(/*! rambdax */"Ex95"),i=n(/*! rxjs/Observable */"4c1C"),s=n(/*! string-fn */"DOxJ"),a=n(/*! ../../_helpers/getNextIndex */"noCf"),c=n(/*! ../../_modules/getConvertedImage */"Ec1U"),l=n(/*! ../../_modules/selectors */"6QbG"),u=n(/*! ../actions */"1Wps"),d=n(/*! ../../_modules/setConvertedImage */"wZsN"),p=n(/*! client-helpers */"RQK/");t.nextEpic=((e,t)=>e.ofType(r.LEARNING_MEME_NEXT).switchMap(()=>new i.Observable(e=>{const{textToSpeechFlag:n}=l.getCommons(t),{currentIndex:i,db:E}=t.getState().learningMemeStore,{easy:f,easier:h,easiest:g,random:m}=p.getterAnt(r.urlInputsDefault),_=g?1:4,S=a.getNextIndex({index:i,length:E.length}),v=E[S],C=[...s.maskSentence({charLimit:_,easyMode:f,easierMode:h,randomMode:m,sentence:v.fromWord}).visible].join(" "),T=s.maskSentence({charLimit:_,easyMode:f,easierMode:h,sentence:v.fromPart,words:v.fromWord.split(" ")}),O=o.map(e=>e.join(" ").trim(),T);c.getConvertedImage(v).then(t=>{const o={convertedImage:t,currentIndex:S,currentInstance:v,question:C,sentence:O};e.next(u.nextReady(o)),n&&e.next(r.sharedSpeak("toPart")),d.setConvertedImage(v),e.complete()})})))},"6QGu":
/*!******************************************!*\
  !*** ./src/lesson/epics/initQuestion.ts ***!
  \******************************************/
/*! no static exports found */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const r=n(/*! ../../constants */"he5r"),o=n(/*! ../actions */"a44Q"),i=n(/*! ../bees/questionList */"ymlt"),s=n(/*! rambdax */"Ex95");t.initQuestionEpic=((e,t)=>e.ofType(r.LESSON_NEXT).filter(()=>(e=>e.getState().lessonStore.currentStep.example)(t)).map(()=>(e=>{const{currentStep:t}=e.getState().lessonStore,n=t.example.split(" ").map(e=>s.test(/\[.*\]/,e)?i.questionListBee(e):e);return o.questionReady(n)})(t)))},"6QbG":
/*!***********************************!*\
...
/*!*************************************************!*\
  ...
  \*************************************************/
/*! no static exports found */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const r=n(/*! client-helpers */"RQK/"),o=n(/*! rambdax */"Ex95"),i=n(/*! ../actions */"o/T1"),s=n(/*! ../../_helpers/mini/normalizeLanguage */"mVbh"),a=700;t.acceptSpeechBee=function(e){const t=r.getter("fromLanguage"),n=new webkitSpeechRecognition,c=e=>{e.error&&console.warn("ACCEPT_SPEECH"),n.stop(),o.delay(a).then(()=>n.start())};n.lang=s.normalizeLanguage(t),n.interimResults=!1,n.continious=!0,n.maxAlternatives=1,n.onerror=c,n.onresult=function(t){const n=t.results[0][0].transcript;e(i.mic(n))},n.onspeechend=c,n.start()}},DZED:
/*!*************************************!*\
...
`;const a=`\n  color: ${r.dark2};\n  letter-spacing: 0.1em;   \n\n  span:not(:first-child) {\n    margin-left: 6px;\n  }\n`;t.Question=o.default(s.getText(.5))`${a}`,t.QuestionSmall=o.default(s.getText(.3))`${a}`,t.QuestionMobile=o.default(s.getText(.25))`
  ${a}
...
/*!*******************************************!*\
  ...
  \*******************************************/
/*! no static exports found */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const r=n(/*! redux-observable */"NOGq"),o=n(/*! ./check */"luEA"),i=n(/*! ./init */"mmTX"),s=n(/*! ./initReady */"prBy"),a=n(/*! ./listen */"4MmZ"),c=n(/*! ./next */"Yr0F"),l=n(/*! ./step */"reJz"),u=n(/*! ./mic */"V27M");t.writeSentenceEpic=r.combineEpics(o.checkEpic,u.micEpic,i.initEpic,s.initReadyEpic,a.listenEpic,c.nextEpic,l.stepEpic)},UHcP:
/*!*******************************************!*\
...
/*!*****************************************!*\
  ...
  \*****************************************/
/*! no static exports found */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const r=n(/*! rxjs/Observable */"4c1C"),o=n(/*! string-fn */"DOxJ"),i=n(/*! ../../constants */"he5r"),s=n(/*! rambdax */"Ex95"),a=n(/*! ../../_modules/selectors */"6QbG"),c=n(/*! ../../root/actions */"X9xb"),l=n(/*! ../actions */"o/T1"),u=e=>t=>t>e;t.micEpic=((e,t)=>e.ofType(i.WRITE_SENTENCE_MIC).filter(()=>(e=>e.getState().writeSentenceStore.listen)(t)).switchMap(e=>new r.Observable(n=>{const r=e.payload,{textToSpeechFlag:i,fromLanguage:d}=a.getCommons(t),p=function(e,t){const n=o.distanceGerman(e,t),r=s.switcher(t.length).is(u(60),1.4).is(u(45),1.3).default(1.15),i=Math.floor(n/r);return s.switcher(i).is(u(20),0).is(u(16),1).is(u(12),2).is(u(9),3).default(13-i)}(r,s.path("writeSentenceStore.currentInstance.fromPart",t.getState()));p>0&&n.next(c.sharedAddPoints(p)),n.next(l.micReady()),n.next(l.notify(r)),i&&n.next(d),n.complete()})))},"VB+0":
/*!***************************************************!*\
...
/*!**********************************!*\
  ...
  \**********************************/
/*! no static exports found */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const r=n(/*! rambdax */"Ex95"),o=n(/*! rxjs/Observable */"4c1C"),i=n(/*! ../bees/parseLesson */"eJae"),s=n(/*! ../../constants */"he5r"),a=n(/*! ../actions */"a44Q");async function c(e){const t=r.glue(`\n    https://gl.githack.com\n    dejantoteff\n    lessons\n    raw\n    master\n    ${r.remove("lesson-",e)}.md\n  `,"/"),n=await async function(e){return(await fetch(e,{method:"GET"})).text()}(t);return a.initReady(i.parseLessonBee(n))}t.initEpic=((e,t)=>e.ofType(s.LESSON_INIT).switchMap(({payload:e})=>(e=>o.Observable.fromPromise(c(e)))(e)))},Xydr:
/*!******************************************!*\
...
/*!******************************************!*\
  ...
  \******************************************/
/*! no static exports found */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const r=n(/*! ../../constants */"he5r"),o=n(/*! client-helpers */"RQK/"),i=n(/*! rambdax */"Ex95"),s=n(/*! rxjs/Observable */"4c1C"),a=n(/*! string-fn */"DOxJ"),c=n(/*! ../../_helpers/getNextIndex */"noCf"),l=n(/*! ../../_modules/selectors */"6QbG"),u=n(/*! ../actions */"o/T1"),d=n(/*! ../../root/actions */"X9xb");t.nextEpic=((e,t)=>e.ofType(r.WRITE_SENTENCE_NEXT).concatMap(()=>new s.Observable(e=>{const{currentIndex:n,db:s,ready:p}=t.getState().writeSentenceStore,{easy:E,easier:f,easiest:h,random:g}=o.getterAnt(r.urlInputsDefault),{textToSpeechFlag:m}=l.getCommons(t),_=c.getNextIndex({index:n,length:s.length}),S=s[_],v=a.maskSentence({sentence:S.fromPart,easyMode:E,easierMode:f,randomMode:g,charLimit:h?1:4}),C=v.visible.map((e,t)=>({hidden:v.hidden[t],visible:e})),T={currentIndex:_,currentInstance:S,okCorrect:Array(C.length).fill(null),question:C};e.next(u.setNext(T));const O=p?r.NEXT_TICK:r.SHORT_DELAY;i.delay(O).then(()=>{e.next({type:r.WRITE_SENTENCE_READY}),m&&e.next(d.sharedSpeakTo),e.complete()})})))},YseZ:
/*!*****************************************************!*\
...
/*!******************************************!*\
  ...
  \******************************************/
/*! no static exports found */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const r=n(/*! client-helpers */"RQK/"),o=n(/*! rambdax */"Ex95"),i=n(/*! react */"q1tI"),s=n(/*! react-redux */"/MKj"),a=n(/*! ./actions */"o/T1"),c=n(/*! ./styled/grid */"oOQG"),l=n(/*! ./styled/image */"Ep3D"),u=n(/*! ./styled/input */"EkVV"),d=n(/*! ./styled/answer */"bjKX"),p=n(/*! ./styled/question */"MLjJ"),E=n(/*! ./styled/translation */"hEQj"),f=n(/*! ./answerList */"Jwh9"),h=n(/*! ./ants/lastCharSpace */"jjzj"),g=n(/*! ./questionList */"66FG"),m=n(/*! ./ants/auto */"49dL"),_=n(/*! ./ants/lock */"ucJp"),S=n(/*! ./bees/get */"emwK"),v=n(/*! ./bees/acceptSpeech */"DYMH");class C extends i.Component{constructor(e){super(e),this.onInputKeyPress=this.onInputKeyPress.bind(this),this.onInputChange=this.onInputChange.bind(this),this.state={lock:r.getter("lock")}}componentDidMount(){const{auto:e,id:t,mic:n,pause:i}=r.masterGetter("auto,pause,id,mic");"number"==typeof e&&m.autoAnt(this.props.dispatch,1e3*e,o.defaultTo(3e3*e,1e3*i)),n&&v.acceptSpeechBee(this.props.dispatch),this.props.dispatch(a.init(t))}onInputKeyPress(e){" "===e.key&&this.props.dispatch(a.listen("SPACE"))}onInputChange(e){h.lastCharSpace(e.target.value)||this.state.lock&&!_.lockAnt(this.props.writeSentenceStore,e)||this.props.dispatch(a.listen(e.target.value))}render(){const{currentInstance:e,inputState:t,ready:n}=this.props.writeSentenceStore;if(!n)return"";const r=S.getBee(e.fromPart.length);return i.createElement("div",null,i.createElement(c.Container,null,i.createElement(u.InputContainer,null,i.createElement(u.Input,null,i.createElement("input",{type:"text",autoFocus:n,value:t,onChange:this.onInputChange,onKeyPress:this.onInputKeyPress}))),i.createElement(p.QuestionContainer,null,i.createElement(r.Question,null,i.createElement(g.QuestionList,Object.assign({},this.props.writeSentenceStore)))),i.createElement(d.AnswerContainer,null,i.createElement(r.Answer,null,i.createElement(f.AnswerList,Object.assign({},this.props.writeSentenceStore)))),i.createElement(l.ImageContainer,null,i.createElement(l.Image,{src:e.imageSrc})),i.createElement(E.TranslationContainer,null,i.createElement(r.Translation,null,e.toPart))))}}t.WriteSentence=C;t.WriteSentenceWrapped=s.connect(({writeSentenceStore:e})=>({writeSentenceStore:e}))(C)},mi1x:
/*!***********************************!*\
...
/*!*******************************!*\
  ...
  \*******************************/
/*! no static exports found */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const r=n(/*! string-fn */"DOxJ"),o=n(/*! rambdax */"Ex95");t.getDB=function(e){const{fromLanguage:t,toLanguage:n,db:i}=e,s=o.filter(e=>{const i=`${t.toLowerCase()}Part`,s=`${n.toLowerCase()}Part`,a=`${t.toLowerCase()}Word`,c=`${n.toLowerCase()}Word`,l=e[i],u=e[a],d=void 0!==e[c],p=void 0!==e[s]&&d;if(!o.allTrue(void 0!==l,void 0!==u,p)||l.length>102)return console.log({xInstance:e}),!1;const E=o.last(u.split(" "));return r.wordsX(l).map(e=>e.toLowerCase()).includes(E.toLowerCase())||function(e){return e.startsWith("по-")||e.startsWith("най-")}(E)},i);return o.map(e=>{const r=e[`${t.toLowerCase()}Part`],o=e[`${t.toLowerCase()}Word`],i=e.imageSrc,s=e[`${n.toLowerCase()}Part`],a=e[`${n.toLowerCase()}Word`];return{altTag:e.altTag,fromPart:r,fromWord:o,imageSrc:i,toPart:s,toWord:a}},s)}},qjlp:
/*!****************************************!*\
...
/*!*****************************************!*\
  ...
  \*****************************************/
/*! no static exports found */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const r=n(/*! rambdax */"Ex95"),o="WAITING",i="ACTIVE",s="[",a="]";function c(e){const[t]=e.split(s);let n=o;const r=[];let c="";return[...e].forEach(e=>e===s?n=i:e===a?(n=o,r.push(c),c=""):void(n!==o&&(c+=e))),[t,...r]}t.wordListAnt=c,t.questionListBee=function(e){const[t,...n]=c(e);if(1===n.length){const e=[{correct:!0,text:t,status:"ACTIVE"},{correct:!1,text:n[0],status:"ACTIVE"}];return[{correct:!1,text:"_",status:"ACTIVE"},...r.shuffle(e)]}const[o,i]=r.shuffle(n),s=[{correct:!0,text:t,status:"ACTIVE"},{correct:!1,text:o,status:"ACTIVE"},{correct:!1,text:i,status:"ACTIVE"}];return r.shuffle(s)}}},[["2YZa","runtime~main","common"]]]);