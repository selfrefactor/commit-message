...
/*!************************************************!*\
  ...
  \************************************************/
/*! no static exports found */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const r=n(/*! client-helpers */"RQK/"),o=n(/*! rambdax */"Ex95"),i=n(/*! ../../_helpers/bees/click */"A+jW"),s=n(/*! ../../_helpers/bees/isNext */"/4J7"),a=n(/*! ../../_helpers/mini/normalizeLanguage */"mVbh"),c=n(/*! ./solved */"1HTa"),l=500;let u;async function d(e){const t=e.results[0][0].transcript;if(console.log({spoken:t}),s.isNextBee(t))return i.clickBee("next");const n=document.getElementsByTagName("input");c.solvedAnt()||(n[0].value=t,await o.delay(u),i.clickBee("submit"))}t.acceptSpeechAnt=function(){const e=r.getter("fromLanguage"),t=new webkitSpeechRecognition;u=1e3*r.getter("pause");const n=e=>{e.error&&console.warn("ACCEPT_SPEECH"),t.stop(),o.delay(l).then(()=>t.start())};t.lang=a.normalizeLanguage(e),t.interimResults=!1,t.continious=!0,t.maxAlternatives=1,t.onerror=n,t.onresult=d,t.onspeechend=n,t.start()}},JTIw:
/*!******************************!*\
