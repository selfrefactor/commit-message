...
/*!******************************************!*\
  ...
  \******************************************/
/*! no static exports found */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const r=n(/*! ../../constants */"he5r"),o=n(/*! client-helpers */"RQK/"),i=n(/*! rambdax */"Ex95"),s=n(/*! rxjs/Observable */"4c1C"),a=n(/*! string-fn */"DOxJ"),c=n(/*! ../../_helpers/getNextIndex */"noCf"),l=n(/*! ../../bees/sharedNextReady */"LHni"),u=n(/*! ../../root/actions */"X9xb"),d=n(/*! ../actions */"o/T1"),p=n(/*! ../../_helpers/selectors */"NDrd"),E=n(/*! ../../bees/setConvertedImage */"0CO9"),f=n(/*! ../../bees/getConvertedImage */"ekhr");t.nextEpic=((e,t)=>e.ofType(r.WRITE_SENTENCE_NEXT).concatMap(()=>new s.Observable(e=>{const{currentIndex:n,db:s,ready:h}=t.getState().writeSentenceStore,{easier:_,easiest:g,easy:m,random:S,visible:v}=o.getterAnt(r.urlInputsDefault),{textToSpeechFlag:C}=p.getCommons(t),T=c.getNextIndex({index:n,length:s.length}),O=s[T];l.sharedNextReadyBee(O),E.setConvertedImageBee(O);const N=a.maskSentence({sentence:O.fromPart,easyMode:m,easierMode:_,randomMode:S,charLimit:g?1:4}),I=N.visible.map((e,t)=>({hidden:N.hidden[t],visible:v?N.hidden[t]:e})),A=Array(I.length).fill(null),x={currentIndex:T,currentInstance:O,okCorrect:A,question:I};e.next(d.setNext(x));const b=h?r.NEXT_TICK:r.SHORT_DELAY;Promise.all([f.getConvertedImageBee(O),i.delay(b)]).then(([t])=>{const n={currentIndex:T,currentInstance:O,okCorrect:A,question:I,convertedImage:t};e.next(d.setNext(n)),e.next({type:r.WRITE_SENTENCE_READY}),C&&e.next(u.sharedSpeakTo),e.complete()})})))},ZPtv:
/*!******************************!*\
