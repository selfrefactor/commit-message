...
/*!*********************************!*\
  ...
  \*********************************/
/*! no static exports found */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const r=n(/*! notify/epic */"MUGr"),o=n(/*! redux-observable */"NOGq"),i=n(/*! ./click */"KN0k"),s=n(/*! ./general */"V/P4"),a=n(/*! ./init */"5E6V"),c=n(/*! ./notify */"Y8OM"),l=n(/*! ./sharedChangeSettings */"hnD8"),u=n(/*! ./sharedSpeak */"dt5O"),d=n(/*! ../../choose_word/epics/ */"HY6S"),p=n(/*! ../../guess_word/epics/ */"3vFA"),E=n(/*! ../../learning_meme/epics/ */"iWvF"),f=n(/*! ../../lesson/epics/ */"RQrR"),h=n(/*! ../../select_article/epics/ */"JDZ+"),_=n(/*! ../../write_sentence/epics/ */"S9pt"),g=n(/*! ./infoEpic */"Gtzr"),m=n(/*! ./sharedAddPoints */"UHcP");t.rootEpic=o.combineEpics(f.lessonEpic,h.selectArticleEpic,g.infoEpic,d.chooseWordEpic,i.clickEpic,s.generalEpic,p.guessWordEpic,a.initEpic,E.learningMemeEpic,c.notifyEpic,r.notifyEpic,m.sharedAddPointsEpic,l.sharedChangeSettingsEpic,u.sharedSpeakEpic,_.writeSentenceEpic)},"7YPl":
/*!*************************************************!*\
...
/*!*****************************************!*\
  ...
  \*****************************************/
/*! no static exports found */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const r=n(/*! rxjs/Observable */"4c1C"),o=n(/*! string-fn */"DOxJ"),i=n(/*! ../../constants */"he5r"),s=n(/*! rambdax */"Ex95"),a=n(/*! ../../root/actions */"X9xb"),c=n(/*! ../actions */"o/T1"),l=n(/*! ../../_helpers/selectors */"NDrd"),u=e=>t=>t>e;t.micEpic=((e,t)=>e.ofType(i.WRITE_SENTENCE_MIC).filter(()=>(e=>e.getState().writeSentenceStore.listen)(t)).switchMap(e=>new r.Observable(n=>{const r=e.payload,{textToSpeechFlag:i,fromLanguage:d}=l.getCommons(t),p=function(e,t){const n=o.distanceGerman(e,t),r=s.switcher(t.length).is(u(60),1.4).is(u(45),1.3).default(1.15),i=Math.floor(n/r);return s.switcher(i).is(u(20),0).is(u(16),1).is(u(12),2).is(u(9),3).default(13-i)}(r,s.path("writeSentenceStore.currentInstance.fromPart",t.getState()));p>0&&n.next(a.sharedAddPoints(p)),n.next(c.micReady()),n.next(c.notify(r)),i&&n.next(d),n.complete()})))},"VB+0":
/*!***************************************************!*\
...
/*!******************************************!*\
  ...
  \******************************************/
/*! no static exports found */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const r=n(/*! ../../constants */"he5r"),o=n(/*! client-helpers */"RQK/"),i=n(/*! rambdax */"Ex95"),s=n(/*! rxjs/Observable */"4c1C"),a=n(/*! string-fn */"DOxJ"),c=n(/*! ../../_helpers/getNextIndex */"noCf"),l=n(/*! ../../bees/sharedNextReady */"LHni"),u=n(/*! ../../root/actions */"X9xb"),d=n(/*! ../actions */"o/T1"),p=n(/*! ../../_helpers/selectors */"NDrd"),E=n(/*! ../../bees/setConvertedImage */"0CO9"),f=n(/*! ../../bees/getConvertedImage */"ekhr");t.nextEpic=((e,t)=>e.ofType(r.WRITE_SENTENCE_NEXT).concatMap(()=>new s.Observable(e=>{const{currentIndex:n,db:s,ready:h}=t.getState().writeSentenceStore,{easy:_,easier:g,easiest:m,random:S}=o.getterAnt(r.urlInputsDefault),{textToSpeechFlag:C}=p.getCommons(t),v=c.getNextIndex({index:n,length:s.length}),T=s[v];l.sharedNextReadyBee(T),E.setConvertedImageBee(T);const O=a.maskSentence({sentence:T.fromPart,easyMode:_,easierMode:g,randomMode:S,charLimit:m?1:4}),N=O.visible.map((e,t)=>({hidden:O.hidden[t],visible:e})),A=Array(N.length).fill(null),I={currentIndex:v,currentInstance:T,okCorrect:A,question:N};e.next(d.setNext(I));const x=h?r.NEXT_TICK:r.SHORT_DELAY;Promise.all([f.getConvertedImageBee(T),i.delay(x)]).then(([t])=>{const n={currentIndex:v,currentInstance:T,okCorrect:A,question:N,convertedImage:t};e.next(d.setNext(n)),e.next({type:r.WRITE_SENTENCE_READY}),C&&e.next(u.sharedSpeakTo),e.complete()})})))},ZPtv:
/*!******************************!*\
...
/*!*************************************************!*\
  ...
  \*************************************************/
/*! no static exports found */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.settingsRandom=function(e,t){return console.log("settingsRandom"),t}},y8dd:
/*!*****************************************!*\
