...
/*!****************************************!*\
  ...
  \****************************************/
/*! no static exports found */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const r=n(/*! styled-components */"vOnD"),o=n(/*! rambdax */"Ex95"),i=n(/*! ../styled/answer */"bjKX"),a=n(/*! ../styled/question */"MLjJ"),s=n(/*! ../styled/grid */"oOQG"),c=n(/*! colors */"dBCm"),l=n(/*! client-helpers */"RQK/"),u=4,d=102,p=1900;function E(e,t){return Number(Number.parseFloat(`${e/t}`).toFixed(2))}function f(e){const t=l.getter("window"),n=o.defaultToStrict(p,t);return E(function(e,t){return Number(Number.parseFloat(`${e/t}`).toFixed(2))}(E(window.visualViewport.width,n),E(e,d)),u)}t.getBee=function(e){const t=f(e.fromPart.length);return{Question:r.default(s.getText(t))`${a.QuestionBase}`,Answer:r.default(s.getText(t))`${i.AnswerBase}`,Translation:r.default(s.getText(f(e.toPart.length)*1.25))`color: ${c.darkblue5};`}}},f6FE:
/*!*******************************!*\
