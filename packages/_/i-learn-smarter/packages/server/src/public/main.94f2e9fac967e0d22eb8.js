...
/*!*******************************!*\
  ...
  \*******************************/
/*! no static exports found */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const r=n(/*! rambdax */"Ex95"),o=window.speechSynthesis,i=new SpeechSynthesisUtterance,a={lang:"en-US",rate:.8,volume:1,pitch:.9},s=Object.assign({},a,{lang:"de-DE"});t.speak=function(e){return new Promise(t=>{const n=function(e){return r.switcher(e.language).is("EN",a).is("DE",s).default(!1)}(e);if(!1===n)return t();i.lang=n.lang,i.pitch=n.pitch,i.rate=n.rate,i.text=e.text,i.volume=n.volume,o.speak(i),i.onend=(()=>{t()})})}},he5r:
/*!**************************!*\
  !*** ./src/constants.ts ***!
  \**************************/
/*! no static exports found */
