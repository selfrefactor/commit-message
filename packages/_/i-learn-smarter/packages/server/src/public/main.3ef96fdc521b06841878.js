...
/*!*******************************!*\
  ...
  \*******************************/
/*! no static exports found */
/*! ModuleConcatenation bailout: Module is not an ECMAScript module */function(e,t,n){"use strict";Object.defineProperty(t,"__esModule",{value:!0});const r=n(/*! string-fn */"DOxJ"),o=n(/*! rambdax */"Ex95");t.getDB=function(e){const{fromLanguage:t,toLanguage:n,db:i}=e,s=o.filter(e=>{const i=`${t.toLowerCase()}Part`,s=`${n.toLowerCase()}Part`,a=`${t.toLowerCase()}Word`,c=`${n.toLowerCase()}Word`,l=e[i],u=e[a],d=void 0!==e[c],p=void 0!==e[s],E=void 0!==l&&void 0!==u&&p&&d,f=l.length>102;if(!E||f)return console.log({xInstance:e}),!1;const g=o.last(u.split(" "));return r.wordsX(l).map(e=>e.toLowerCase()).includes(g.toLowerCase())||function(e){return e.startsWith("по-")||e.startsWith("най-")}(g)},i);return o.map(e=>{const r=e[`${t.toLowerCase()}Part`],o=e[`${t.toLowerCase()}Word`],i=e.imageSrc,s=e[`${n.toLowerCase()}Part`],a=e[`${n.toLowerCase()}Word`];return{altTag:e.altTag,fromPart:r,fromWord:o,imageSrc:i,toPart:s,toWord:a}},s)}},qjlp:
/*!****************************************!*\
